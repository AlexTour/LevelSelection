...
document.getElementById("image01-container").style.backgroundImage = "url('./Assets/poster.png')"; 

document.getElementById('room02-title').textContent = "ERDGESCHOSS (2/2)";
...
document.getElementById("image02-container").style.backgroundImage = "url('./Assets/poster.png')"; 

document.getElementById('room03-title').textContent = "OBERGESCHOSS (1/3)";
...
document.getElementById("image03-container").style.backgroundImage = "url('./Assets/poster.png')"; 

document.getElementById('room04-title').textContent = "OBERGESCHOSS (2/3)";
...
document.getElementById("image04-container").style.backgroundImage = "url('./Assets/poster.png')"; 
